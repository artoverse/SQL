...
-- select dname from emp where deptno = (select deptno from dept where dname='Sales'); // failes

/* Aliases can be useful when:    -- mandatory on selfjoin
...
select distinct job from Emp; --** avoids repitetion 
